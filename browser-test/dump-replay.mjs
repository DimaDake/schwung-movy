...
const SWITCHES_EXPECTED = [
    ...
    'sound_generator--slicer::mono_mode',
    'sound_generator--slicer::playthrough',
    'sound_generator--slicer::slice_algo',
    'sound_generator--slicer::slice_mode',
    'sound_generator--slicer::sync',
    'sound_generator--slicer::velocity_sens',
