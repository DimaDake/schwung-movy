...
const segments = [
  ...
  { name: 'Track 1 — OB-Xd', start: 93.5, every: 4.0, hold: 3.5, cards: [
    ...
    ["LOADING OB-XD", "Stop on OB-Xd, click the jog."],
    ["A CLASSIC ANALOG POLY", "Play a chord on the pads — it sounds straight away."],
    ["NOTHING TO SET UP", "Play a few more chords."],
    ["NOW LOOK AT THE SCREEN", "Hands off. PiP: OB-Xd Main page."],
    ["MOVY BUILT THIS FROM THE SYNTH", "PiP: Main page held."],
    ["NOBODY DREW IT BY HAND", "PiP: Main page held."],
    ["IT FOUND THE ATTACK AND DECAY", "PiP: envelope graphic on the Main page."],
    ["AND DREW ONE ENVELOPE", "PiP: env_dual."],
    ["TURN A KNOB — IT REDRAWS", "Turn DECAY, then RELEASE; the envelope reshapes live."],
    ["IT FOUND THE FILTER TOO", "PiP: filter curve on the same page."],
    ...
    ["THAT'S THE SOUND, DESIGNED", "Play a chord — the new sound."],
    ["NOW THE PADS", "Hand moves to Shift."],
    ["SHIFT + STEP 5 = SET PAGE", "Shift + Step 5. PiP: main-default."],
    ["SET MODE TO IN KEY", "Turn knob 7 to In Key. PiP: main-mode-overlay. Pads relight."],
    ["A WRONG NOTE IS IMPOSSIBLE", "Run a hand across the pads — every note fits."],
    ["REC. COUNT-IN. PLAY THE BASS.", "Tap Rec. Count-in bar, then play the bass line."],
    ["MY TIMING IS HUMAN. THAT'S FINE.", "Finish the take, deliberately a little behind the beat. Tap Rec."],
    ["REMEMBER THAT. WE'LL COME BACK.", "Bass loops on its own. Hands off."],
  ]},
  { name: 'Track 2 — Mr Drums', start: 186, every: 4.0, hold: 3.5, cards: [
    ...
    ["SAME GESTURE SWAPS ITS SAMPLE", "Jog to page 1. PiP: SAMPL cell."],
  ...
  { name: 'Beyond Move ① — clip page', start: 259, every: 4.0, hold: 3.5, cards: [
    ...
    ["PER CLIP. NOT PER SET.", "PiP: clip page held."],
    ["MINOR → PHRYGIAN", "Turn knob 1 to Phrygian. The bass re-maps."],
    ["ONE KNOB. NEW MOOD.", "Loop plays in the new scale. Hands off."],
  ]},
  { name: 'Track 3 — Weird Dreams / step recording', start: 308, every: 3.9, hold: 3.4, cards: [
  ...
  { name: 'Beyond Move ② — step parameters', start: 363, every: 4.2, hold: 3.6, cards: [
  ...
  { name: 'Track 4 — Helm', start: 422, every: 4.2, hold: 3.6, cards: [
    ...
    ["TURN THE JOG TO WALK THEM", "Keep turning; page headers stream past."],
    ["SHIFT + JOG SKIPS BY SECTION", "Shift + jog; sections jump."],
    ...
    ["ALL OF IT BUILT AUTOMATICALLY", "Turn its rate; the waveform animates."],
    ["MOVY DIDN'T KNOW THIS SYNTH", "Play the lead over the loop."],
    ["IT JUST READ IT", "Loop plays with the lead. Hands off."],
  ]},
  { name: 'LFO — hold to assign', start: 478, every: 4.0, hold: 3.5, cards: [
    ["EVERY TRACK GETS TWO MORE", "Back to chain view. PiP: LFO slot at the end of the chain."],
    ["MOVY'S OWN. ON ANY PARAMETER.", "Press track 1. PiP: OB-Xd filter page."],
  ...
  { name: 'Automation and undo', start: 519, every: 4.0, hold: 3.5, cards: [
  ...
  { name: 'Session view + flashes', start: 560, every: 3.9, hold: 3.4, cards: [
  ...
  { name: 'Outro', start: 581, every: 4.0, hold: 3.5, cards: [
