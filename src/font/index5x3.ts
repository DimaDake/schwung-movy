...
/* Exported so a test can enumerate the font's coverage without a second copy of
 * the string drifting from this one. */
export const CHARS5 = ' !"\'()+,-./:0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ%<>=?*';
