 ...
 * is — position, not hue. That matters because the sixteen colours have to be
 * told apart by someone with a red-green deficiency too, and position is the
 * cue that never fails. */

import { appState } from '../app/state.js';
import { TRACK_COUNT, trackGroup } from '../track/ref.js';
import { selectTrack } from '../track/focus.js';
import { C_BLACK, trackColor, trackColorDim } from './colors.js';
